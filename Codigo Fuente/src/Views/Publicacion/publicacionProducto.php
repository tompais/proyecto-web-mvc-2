            ...
            <div class="col">
                <div class="breadcrumbs d-flex flex-row align-items-center">
                    <ul>
                        ...
                        <li><a href="categories.html"><i class="fa fa-angle-right" aria-hidden="true"></i><?php echo $categoria->getNombre() ?></a></li>
                    </ul>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 thumbnails_col order-lg-1 order-2">
                            <div class="single_product_thumbnails">
                                <ul>
                                    <li><img src="<?php echo getBaseAddress() . "Webroot/img/publicacion/single_1.jpg" ?>"></li>
                                    <li><img src="<?php echo getBaseAddress() . "Webroot/img/publicacion/single_2.jpg" ?>"</li>
                                    <li><img src="<?php echo getBaseAddress() . "Webroot/img/publicacion/single_3.jpg" ?>"></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-9 image_col order-lg-2 order-1">
                            <div class="single_product_image">
                                <div class="single_product_image_background" style="background-image:url(<?php echo getBaseAddress() . "Webroot/img/publicacion/single_1.jpg" ?>)"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8">
                            ...
                            <ul class="container details">
                                <li><p><i class="fas fa-mobile-alt" style="width:30px;"></i><?php echo $usuario->getTelefonoCelular() ?></p></li>
                                <li><p><i class="fas fa-envelope" style="width:30px;"></i><?php echo $usuario->getEmail() ?></p></li>
                                <li><p><i class="fas fa-calendar-alt" style="width:30px;"></i><?php echo $usuario->getFechaNacimiento() ?></p></li>
                                <li><p><i class="fas fa-map-marker-alt" style="width:30px;" ></i>Localidad</p>
                            </ul>
                        </div>
                    </div>
                </div>
